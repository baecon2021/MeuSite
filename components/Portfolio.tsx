  ...
  const projects: Project[] = [
    {
      ...
      image: "https://media.discordapp.net/attachments/647145748915421189/1461842472920682799/hinove-project.png?ex=696c0665&is=696ab4e5&hm=cd52120dcd123b7c32cefd805d76368c453967474bee116a917f41934975c12d&=&format=webp&quality=lossless&width=973&height=547",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="hidden md:block mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 opacity-40 hover:opacity-100 transition-opacity duration-500">
                {[1, 2, 3].map((i) => (
                    <div key={i} className="border-2 border-dashed border-navy-800 rounded-xl h-48 flex flex-col items-center justify-center text-slate-500 p-6 text-center hover:border-cyan-500/50 hover:text-cyan-400 transition-colors bg-white/5">
